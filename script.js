...
const translations = {
  ...
  fr: {
    ...
    cert_title: "Expertises agréées",
    cert_1: "Ingénieur-conseil en électricité (agréé par le MEHAT)",
    cert_2: "Ingénieur-conseil en sécurité incendie (agréé par l'ONPC)",
    cert_3: "Expert auditeur en énergie (agréé par l'ANME)",
    cert_4: "Expert en photovoltaïque (agréé par l'ANME)",
    cert_5: "Expert en système de management de l'énergie (agréé par GIZ)",
  ...
  en: {
    ...
    cert_title: 'Accredited Expertise',
    cert_1: 'Electrical Consulting Engineer (Accredited by MEHAT)',
    cert_2: 'Fire Safety Consulting Engineer (Accredited by ONPC)',
    cert_3: 'Expert Auditor in Energy (Accredited by ANME)',
    cert_4: 'Expert in Photovoltaic (Accredited by ANME)',
    cert_5: 'Energy Management System Expert (Accredited by GIZ)',
    ...
    eyebrow_contact: 'Contact',
    hero_title: 'Accredited Engineering Office in Electrical Engineering',
