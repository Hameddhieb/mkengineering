...
const translations = {
  ...
  fr: {
    ...
    theme_dark: "Sombre",
    theme_light: "Clair",
    sponsor_aria: "Références partenaires",
    sponsor_alt: "Logo partenaire",
    hero_eyebrow: "RÉFÉRENCES PROJETS",
    ...
    search_placeholder: "Rechercher par client, localisation, collaboration ou périmètre du projet",
    th_owner: "Propriétaire / Client",
    th_country: "Pays",
    th_project: "Projet",
    th_note: "Note de référence",
    results_prefix: "Affichage de",
    results_suffix: "références",
    no_results: "Aucune référence ne correspond au filtre actuel.",
    stat_total: "Total des références",
...
const countryNames = {
  ...
  'Islamic Republic of Mauritania': { ar: 'الجمهورية الإسلامية الموريتانية', fr: 'République islamique de Mauritanie', en: 'Islamic Republic of Mauritania' },
  'Sultanate of Oman': { ar: 'سلطنة عمان', fr: "Sultanat d'Oman", en: 'Sultanate of Oman' },
  'Ivory Coast': { ar: 'ساحل العاج', fr: "Côte d'Ivoire", en: 'Ivory Coast' },
  'Republic Burkina Faso': { ar: 'جمهورية بوركينا فاسو', fr: 'République du Burkina Faso', en: 'Republic Burkina Faso' },
